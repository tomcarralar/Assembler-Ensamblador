...
Funcionalidad
El programa recibe una cadena de entrada que consiste en una operación seguida de uno o dos operandos
 (cadenas). Luego, ejecuta la operación correspondiente y muestra el resultado en pantalla. 
...
Para operaciones que requieren solo un operando (por ejemplo, len, lwc, upc), cualquier segundo operando será 
ignorado sin generar error.
